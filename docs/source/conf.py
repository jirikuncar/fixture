# -*- coding: utf-8 -*-
#
# fixture documentation build configuration file, created by
# sphinx-quickstart on Tue Jun  3 14:50:30 2008.
#
...
latex_documents = [
  ('index', 'fixture.tex', 'fixture Documentation', 'Kumar McMillan', 'manual'),
]
